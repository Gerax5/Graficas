...
modelo2 = Model("OBJ/Shrek.obj")
modelo2.LoadTexture("texture/sss.bmp")
modelo2.vertexShader = vertexShader
modelo2.fragmentShader = pixelationShader
...
modelo2.translate[2] = -0.3
modelo2.translate[1] = -0.15
modelo2.translate[0] = 0.2
modelo2.scale[0] = 0.025
modelo2.scale[1] = 0.025
modelo2.scale[2] = 0.025
...
modelo3.fragmentShader = wireframeShader
